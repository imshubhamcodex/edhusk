...
export default {
  ...
  data () {
    return {
      ...
      form: {
        ...
        standard: 'this.$route.params.activity',
        subjects: [],
        level: '',
        type_coaching: '',
        travel: '',
  ...
  validate ({ params }) {
    return /^dietician$|^fitness-trainer$|^yoga$|^zumba$/.test(params.activity)
  }
}
</script>
