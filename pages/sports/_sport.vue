        ...
        <ValidationObserver ref="form">
          <form action="post">
            <b-steps v-model="step">
              <b-step-item
                v-if="form.standard === 'martial-arts'"
                icon="check-square"
                label="Subject"
              >
              ...
              >
                <ValidationObserver ref="preferenceSection">
                  ...
                  <form-dropdown
                    ...
                    label="How many students will be getting coached?"
                    rules="required"
                  >
                    <option value>
                      Select an option
                    ...
                    <option
                      v-for="(item, i) in numberOfStudentArray"
                      :key="`${item.value}-${i}`"
                      :value="item.value"
                    >
                      {{ item.text }}
              ...
              >
                <ValidationObserver ref="typeSection">
                  ...
                  <form-dropdown
                    v-if="(form.standard === 'chess' || form.standard === 'skating') && type_coaching !== 'batch'"
              ...
              >
                <ValidationObserver ref="locationSection">
                  <form-dropdown
                    v-model="form.gender"
                    label="What is the gender of the student?"
                    rules="required"
                  >
                    <option value>
                      Select a gender
...
export default {
  ...
  data () {
    return {
      ...
      form: {
        ...
        standard: 'this.$route.params.sport',
        subjects: [],
        level: '',
        type_coaching: '',
        travel: '',
  ...
  validate ({ params }) {
    return /^badminton$|^basketball$|^chess$|^cricket$|^football$|^martial-arts$|^running$|^skating$|swimming$|^vollyball$/.test(params.sport)
  }
}
</script>
